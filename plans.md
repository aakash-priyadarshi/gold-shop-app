...
5. **Daily Habit Hook & Gamified Conversions:** Displaying live gold spot prices and AI daily gold forecasts, offering one-click demo data hydration sandboxes, 60-day free trials, and milestone quest rewards that award free AI design credits with confetti animations.
...
- **Live Gold Market Pulse Ticker & AI Price Forecast (The Hook):**
  ...
  - Embed an **"AI Gold Price Forecast Insight"** panel showing daily advice: _"Gold price rose by +0.84% today. AI recommends locking in ring-inventory stock now."_ Jewellers will open this page every single morning just for this tool.
...
- **Self-Service 60-Day Free Pro Trial:** Add a premium self-activation billing card to activate a Pro subscription for 60 days without requiring credit card inputs.
...
8. **`apps/web/src/app/dashboard/shop/page.tsx`**
   ...
   - Embed the One-Click Demo Store Hydrator, self-service 60-Day Trial activator, and the Confetti Quest progression checklist.
...
| **Feature E4: Self-Service 60-Day Trial** | `dashboard/shop/page.tsx`                                                                               | ✅ Done — Card links to billing for free trial subscription activation                    |
