    ...
    Promise.allSettled([
      ...
      setAccounts(
        accRes.status === "fulfilled"
          ? Array.isArray(accRes.value.data)
            ? accRes.value.data
      ...
      setPosts(
        postRes.status === "fulfilled"
          ? Array.isArray(postRes.value.data)
            ? postRes.value.data
    ...
    try {
      await socialApi.createPost({
        ...
        scheduledAt: postForm.scheduledAt
          ? new Date(postForm.scheduledAt).toISOString()
          : undefined,
      });
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your social media command center
          </p>
        </div>
            ...
            <div className="grid gap-4 py-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setPostForm({ ...postForm, accountId: v })
                  }
                >
                  <SelectTrigger>
        ...
        <div className="grid gap-4 md:grid-cols-4">
          {[
            { label: "Total Followers", value: analytics.totalFollowers ?? 0 },
            {
              ...
              value: analytics.postsThisMonth ?? posts.length,
            },
            {
                ...
                <Card key={acc.id}>
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge
                        variant={
                          acc.isConnected !== false ? "success" : "destructive"
                        }
                      >
