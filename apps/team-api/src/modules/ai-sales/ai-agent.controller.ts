...
Return JSON:
{
  ...
  async seedVectorBrain() {
    const seeds = [
      ...
      { id: "company:origin_story", text: "Orivraa was born from firsthand experience with Indian jewellery retailers who still rely on paper ledgers and manual phone calls. The platform bridges the gap between traditional trust-based selling and modern AI-driven efficiency.", category: "company", key: "origin_story", label: "Origin Story" },
      { id: "company:tech_differentiation", text: "Orivraa's technical stack includes Pipecat Cloud voice agents, Qdrant vector memory, Google Gemini for real-time reasoning, Daily.co for video meetings, and Twilio for telephony — all purpose-built for the jewellery vertical.", category: "company", key: "tech_differentiation", label: "Tech Differentiation" },
      { id: "company:customer_promise", text: "Orivraa guarantees measurable results within 30 days: at least 20% more follow-ups completed, 15% higher customer re-engagement, and zero missed anniversary or birthday reminders.", category: "company", key: "customer_promise", label: "Customer Promise" },

      // ═══════════════════════════════════════════
      // PRODUCT KNOWLEDGE (12 points)
      // ═══════════════════════════════════════════
      ...
      { id: "product:features_pos", text: "Orivraa POS module handles in-store billing, GST invoicing, barcode scanning, weight-based pricing with making charges, old gold exchange calculations, and real-time gold rate integration.", category: "product", key: "features_pos", label: "POS Features" },
      { id: "product:features_meetings", text: "Video meeting system supports branded meeting rooms with Orivraa's gold theme, screen sharing for product catalogs, recording with auto-transcription, and AI-powered meeting summaries sent to both parties.", category: "product", key: "features_meetings", label: "Meeting Features" },
      { id: "product:features_analytics", text: "Analytics dashboard provides: conversion funnel visualization, call outcome heatmaps by time/day, agent performance scorecards, revenue attribution per lead source, and AI-generated weekly business insights.", category: "product", key: "features_analytics", label: "Analytics Features" },
      { id: "product:onboarding_process", text: "Onboarding takes under 48 hours: Day 1 — account setup, data import, WhatsApp business API connection. Day 2 — AI agent training with shop-specific knowledge, test calls, and go-live. Dedicated onboarding manager assigned.", category: "product", key: "onboarding_process", label: "Onboarding Process" },
      { id: "product:integrations", text: "Orivraa integrates with: WhatsApp Business API, Twilio telephony, Google Calendar, Google Meet, Zoom, payment gateways (Razorpay, PhonePe), accounting software (Tally, Busy), and custom ERP via REST API.", category: "product", key: "integrations", label: "Integration Ecosystem" },
      { id: "product:data_security", text: "All customer data is encrypted at rest (AES-256) and in transit (TLS 1.3). Hosted on Railway infrastructure with automated daily backups. GDPR-compliant data handling with right-to-delete support.", category: "product", key: "data_security", label: "Data Security" },
      { id: "product:mobile_experience", text: "Orivraa's responsive web app works perfectly on mobile browsers. Shop owners can manage leads, check analytics, and even listen to AI call recordings directly from their phone while on the shop floor.", category: "product", key: "mobile_experience", label: "Mobile Experience" },

      // ═══════════════════════════════════════════
      // SALES STRATEGIES (14 points)
      // ═══════════════════════════════════════════
      ...
      { id: "strategy:objection_price", text: "When customer says price is too high: Acknowledge the concern first, then highlight that Orivraa saves 2-3 hours daily per staff member, equivalent to ₹15,000+ monthly savings. Offer a 60-day free trial.", category: "strategy", key: "objection_price", label: "Price Objection" },
      ...
      { id: "strategy:closing_trial", text: "Best closing technique for hot leads: Offer a 60-day free trial with full onboarding support. Say 'Let me set up your account right now — you'll see results in the first week or we refund you completely.'", category: "strategy", key: "closing_trial", label: "Trial Close" },
      ...
      { id: "strategy:objection_no_time", text: "When the prospect says 'I'm too busy right now': Respect their time, say 'I completely understand — running a jewellery shop is demanding. Can I send you a 2-minute video and call back at a time that works better for you?' Always get a specific callback time.", category: "strategy", key: "objection_no_time", label: "No Time Objection" },
      { id: "strategy:objection_not_tech_savvy", text: "When prospect says 'I'm not good with technology': Emphasize that Orivraa is designed for non-technical users. The AI does the heavy lifting. Mention that if they can use WhatsApp, they can use Orivraa. Offer to do a live walkthrough on a video call.", category: "strategy", key: "objection_not_tech_savvy", label: "Tech Savvy Objection" },
      { id: "strategy:objection_happy_current", text: "When prospect says 'We're happy with our current system': Ask 'That's great! May I ask — does your current system automatically call customers on their anniversary with a personalized offer?' Plant the seed of what they're missing without criticizing their choice.", category: "strategy", key: "objection_happy_current", label: "Happy Current System" },
      { id: "strategy:discovery_questions", text: "Key discovery questions to ask: 1) How many customers visit your shop monthly? 2) How do you currently follow up after a visit? 3) What happens after festival season — do customers come back? 4) How many staff hours go into manual calls? 5) What's your biggest challenge in repeat business?", category: "strategy", key: "discovery_questions", label: "Discovery Questions" },
      { id: "strategy:upsell_starter_to_pro", text: "To upsell Starter to Pro: Wait until they hit the 500-lead limit or exhaust 50 call minutes. Then show them the Pro ROI: 'You've already seen results with 50 calls. Imagine unlimited calls — your conversion rate data shows you'd close ₹X more per month.'", category: "strategy", key: "upsell_starter_to_pro", label: "Upsell Strategy" },
      { id: "strategy:referral_ask", text: "Best time to ask for referrals: Right after the customer reports a positive outcome (e.g., recovered a dormant customer via AI call). Say: 'That's wonderful! Do you know any other jeweller friends who might benefit from this? We offer a referral bonus.'", category: "strategy", key: "referral_ask", label: "Referral Strategy" },
      { id: "strategy:demo_structure", text: "Ideal demo flow (15 minutes): 1) 2 min — acknowledge their pain point from discovery. 2) 5 min — show AI making a live call to a test number. 3) 3 min — show CRM with their kind of data. 4) 3 min — show analytics dashboard. 5) 2 min — pricing and trial offer.", category: "strategy", key: "demo_structure", label: "Demo Structure" },
      { id: "strategy:reactivation", text: "For dormant leads (no contact >30 days): Lead with new value — a feature launch, a case study, or a festival-specific campaign template. Never say 'just following up'. Say 'I thought of you because we just launched [feature] that solves [their specific pain].'", category: "strategy", key: "reactivation", label: "Lead Reactivation" },
      { id: "strategy:multi_touch", text: "Optimal multi-touch sequence: Day 1 — AI call (introduce). Day 3 — WhatsApp message with a short video. Day 7 — Email with a case study. Day 10 — AI call (follow up on materials sent). Day 14 — Final call with a limited-time offer. Spread touches across channels.", category: "strategy", key: "multi_touch", label: "Multi-Touch Sequence" },

      // ═══════════════════════════════════════════
      // CUSTOMER SEGMENTS (7 points)
      // ═══════════════════════════════════════════
      ...
      { id: "segment:diamond_dealers", text: "Diamond and precious stone dealers: High-value, low-volume transactions. They need detailed customer preference tracking, appointment scheduling, and secure document sharing for certifications (GIA, IGI). Privacy and discretion are paramount.", category: "segment", key: "diamond_dealers", label: "Diamond Dealer Segment" },
      { id: "segment:online_jewellers", text: "Online jewellery stores / D2C brands: Need integration with e-commerce platforms, abandoned cart follow-ups via AI calls, and post-purchase nurturing. They value automation at scale and data-driven segmentation.", category: "segment", key: "online_jewellers", label: "Online Jeweller Segment" },
      { id: "segment:bridal_specialists", text: "Bridal and wedding jewellery specialists: Extremely seasonal business. Need wedding date-based follow-up sequences, family relationship mapping (bride's mother, groom's sister), and multi-appointment tracking for custom designs.", category: "segment", key: "bridal_specialists", label: "Bridal Specialist Segment" },
      { id: "segment:franchise_chains", text: "Large franchise chains (20+ stores): Need centralized reporting across branches, role-based access, franchise-specific AI agents with local language, and head-office analytics dashboards. Enterprise pricing with white-label options.", category: "segment", key: "franchise_chains", label: "Franchise Chain Segment" },

      // ═══════════════════════════════════════════
      // MARKET INTELLIGENCE (6 points)
      // ═══════════════════════════════════════════
      ...
      { id: "market:digital_adoption", text: "Post-COVID digital adoption in Indian retail jewellery jumped from 8% to 22%. Younger generation owners (25-40 age group) are actively seeking tech solutions. Target this demographic first — they become internal champions.", category: "market", key: "digital_adoption", label: "Digital Adoption Trends" },
      { id: "market:competition_landscape", text: "Competitive landscape: Generic CRMs (Zoho, HubSpot) lack jewellery-specific features. Jewellery ERPs (Satyam, Codeura) lack AI and CRM. No direct competitor combines AI calling + jewellery CRM + video meetings. Orivraa owns this intersection.", category: "market", key: "competition_landscape", label: "Competitive Landscape" },
      { id: "market:gold_price_impact", text: "When gold prices rise sharply, customers delay purchases but increase inquiries. AI agents should shift messaging from 'buy now' to 'lock today's rate with a small advance' or 'gold savings plan'. When prices dip, trigger urgency campaigns.", category: "market", key: "gold_price_impact", label: "Gold Price Impact" },
      { id: "market:regional_preferences", text: "Regional jewellery preferences: South India — heavy gold (temple jewellery, Kasu Mala); North India — Kundan, Polki, Meenakari; West India — lightweight, contemporary designs; East India — filigree work, traditional Bengal gold. AI must tailor product references by region.", category: "market", key: "regional_preferences", label: "Regional Preferences" },

      // ═══════════════════════════════════════════
      // AI BEHAVIOR GUIDELINES (8 points)
      // ═══════════════════════════════════════════
      ...
      { id: "ai:call_structure", text: "Ideal AI call structure: 1) Warm greeting with name (10s). 2) Rapport hook — reference last interaction or relevant context (20s). 3) Discovery — ask one open question (30s). 4) Value proposition tied to their answer (60s). 5) Handle objection if any (30s). 6) Clear next step / close (20s). Total target: 3-5 minutes.", category: "ai", key: "call_structure", label: "Call Structure" },
      { id: "ai:emotional_intelligence", text: "Emotion detection rules: If customer sounds frustrated — slow down, lower energy, acknowledge the frustration. If excited — match energy, build momentum. If distracted — offer to call back. If skeptical — lean into data and proof points, not enthusiasm.", category: "ai", key: "emotional_intelligence", label: "Emotional Intelligence" },
      { id: "ai:escalation_rules", text: "Escalate to human agent when: 1) Customer explicitly asks for a human. 2) Customer is angry and repeating the same concern. 3) Technical question the AI can't answer after 2 attempts. 4) Customer wants to negotiate custom pricing. 5) Legal or compliance questions.", category: "ai", key: "escalation_rules", label: "Escalation Rules" },
      { id: "ai:voicemail_strategy", text: "If call goes to voicemail: Leave a 20-second message. Include: your name, company (Orivraa), one specific benefit relevant to them, and a callback number. Example: 'Hi [name], this is [agent] from Orivraa. I have a quick idea to help you bring back customers after the wedding season. Call me at [number] or I'll try again tomorrow.'", category: "ai", key: "voicemail_strategy", label: "Voicemail Strategy" },
      { id: "ai:active_listening", text: "Active listening cues the AI should use: 'I hear you', 'That makes sense', 'So if I understand correctly...', 'That's a really common challenge we hear from jewellers in [their city]'. Paraphrase their concern before responding — it builds trust and proves understanding.", category: "ai", key: "active_listening", label: "Active Listening" },
      { id: "ai:cultural_nuances", text: "Indian business cultural nuances: Use 'ji' suffix for respect (e.g., 'Sharma ji'). Avoid scheduling calls during lunch (1-2 PM) or puja times. Respect regional festivals (Pongal in Tamil Nadu, Onam in Kerala). Monday mornings and Saturday afternoons are low-answer times for shop owners.", category: "ai", key: "cultural_nuances", label: "Cultural Nuances" },

      // ═══════════════════════════════════════════
      // PSYCHOLOGY & PERSUASION (6 points)
      // ═══════════════════════════════════════════
      { id: "psychology:reciprocity", text: "Reciprocity principle: Give value before asking for anything. Share a free gold rate alert tool, a festival campaign template, or an industry insight report. When you give first, the prospect feels obligated to reciprocate with their time and attention.", category: "psychology", key: "reciprocity", label: "Reciprocity Principle" },
      { id: "psychology:social_proof", text: "Social proof tactics: Mention specific numbers — '347 jewellers in Gujarat already use Orivraa'. Use city-specific proof — 'Your neighbor on MG Road, Sharma Jewellers, recovered 23 dormant customers last month using our AI calls.' Real names and specific results are 3x more convincing than generic claims.", category: "psychology", key: "social_proof", label: "Social Proof" },
      { id: "psychology:loss_aversion", text: "Loss aversion framing: Instead of 'You'll gain ₹15,000 in savings', say 'Right now, you're losing ₹15,000 every month to manual follow-ups that could be automated.' People are 2x more motivated to avoid losses than to acquire equivalent gains.", category: "psychology", key: "loss_aversion", label: "Loss Aversion" },
      { id: "psychology:anchoring", text: "Price anchoring technique: Before revealing the ₹799/month Pro price, anchor against their current cost — 'Most jewellers spend ₹5,000-8,000/month on a dedicated telecaller who makes 30 calls a day. Orivraa's AI makes 200+ calls for ₹799/month.' The contrast makes the price feel like a bargain.", category: "psychology", key: "anchoring", label: "Price Anchoring" },
      { id: "psychology:commitment_consistency", text: "Commitment and consistency: Get small yeses before the big ask. 'Would you agree that following up with past customers is important?' (Yes.) 'And that your staff sometimes misses these follow-ups?' (Yes.) 'What if you could automate that entirely?' Each yes builds momentum toward the close.", category: "psychology", key: "commitment_consistency", label: "Commitment & Consistency" },
      { id: "psychology:storytelling", text: "Storytelling framework: Every pitch should include one micro-story. 'Last month, a jeweller in Jaipur told me he'd lost touch with 400 customers after Diwali. We set up Orivraa's AI, and in the first week, 47 of those customers came back to the shop. One of them bought a ₹2 lakh set.' Stories are remembered 22x more than facts alone.", category: "psychology", key: "storytelling", label: "Storytelling Power" },

      // ═══════════════════════════════════════════
      // OPERATIONS & ROI (5 points)
      // ═══════════════════════════════════════════
      { id: "operations:roi_calculator", text: "ROI talking points: Average jeweller has 2000 customers. 60% are dormant (no visit in 6 months). If AI reactivates just 5% (60 customers) and average purchase is ₹25,000, that's ₹15 lakh in recovered revenue. Orivraa costs ₹799/month. ROI is 150x+.", category: "operations", key: "roi_calculator", label: "ROI Calculator" },
      { id: "operations:implementation_timeline", text: "Typical implementation timeline: Hour 0-2 — account setup and data import (CSV or manual). Hour 2-4 — AI agent configuration (voice, language, persona). Hour 4-8 — test calls and refinements. Day 2 — live calls begin. Week 1 — first analytics review. Week 4 — full ROI assessment.", category: "operations", key: "implementation_timeline", label: "Implementation Timeline" },
      { id: "operations:data_migration", text: "Data migration support: We accept CSV, Excel, or direct API import. For jewellers using paper ledgers, our team helps digitize up to 5000 records free of charge. For Tally/Busy users, we have one-click import plugins. No data is ever lost during migration.", category: "operations", key: "data_migration", label: "Data Migration" },
      { id: "operations:support_model", text: "Support model: All plans include WhatsApp support (response within 2 hours). Pro and Enterprise get a dedicated success manager. Enterprise gets priority phone support. Monthly business reviews included in Pro+. 99.9% uptime SLA for Enterprise.", category: "operations", key: "support_model", label: "Support Model" },
      { id: "operations:training", text: "Training provided: 1-hour live video onboarding session. Step-by-step video library in Hindi and English. In-app guided tours for every feature. Monthly webinars on best practices. Dedicated WhatsApp group for Pro/Enterprise customers with real-time help.", category: "operations", key: "training", label: "Training & Enablement" },

      // ═══════════════════════════════════════════
      // INDUSTRY & COMPLIANCE (4 points)
      // ═══════════════════════════════════════════
      { id: "industry:hallmarking", text: "BIS Hallmarking mandate: Since June 2021, gold jewellery must be BIS hallmarked. Orivraa's POS integrates hallmark verification, tracks HUID numbers, and auto-generates compliant invoices. This is a strong selling point for shops worried about compliance.", category: "industry", key: "hallmarking", label: "Hallmarking Compliance" },
      { id: "industry:gst_compliance", text: "GST for jewellers: 3% GST on gold jewellery, 5% on making charges. Orivraa auto-calculates split GST, generates GST-compliant invoices, and exports data in Tally-compatible format. Saves hours of accountant time.", category: "industry", key: "gst_compliance", label: "GST Compliance" },
      { id: "industry:kyc_requirements", text: "KYC requirements: Purchases above ₹2 lakh require PAN card. Orivraa's CRM flags high-value transactions and prompts KYC document collection. Stores documents securely linked to customer profiles.", category: "industry", key: "kyc_requirements", label: "KYC Requirements" },
      { id: "industry:digital_gold", text: "Digital gold trend: Platforms like Paytm Gold and Google Pay Gold are creating new buying behaviors. Young customers expect digital-first experiences. Orivraa positions traditional jewellers to compete with digital-first players by adding AI and automation layers.", category: "industry", key: "digital_gold", label: "Digital Gold Trend" },
    ];
