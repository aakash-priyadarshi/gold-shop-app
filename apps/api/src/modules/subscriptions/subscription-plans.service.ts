  ...
  async createPlan(dto: CreatePlanDto) {
    ...
    return this.prisma.subscriptionPlan.create({
      data: {
        ...
        softLimitCustomers: dto.softLimitCustomers,
        softLimitInvoicesPerMonth: dto.softLimitInvoicesPerMonth,
        softLimitProducts: dto.softLimitProducts,
        softLimitSavingsSchemes: dto.softLimitSavingsSchemes,
