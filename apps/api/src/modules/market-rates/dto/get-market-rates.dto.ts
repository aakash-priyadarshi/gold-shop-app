...
export class GetMarketRatesDto {
  @ApiProperty({
    description:
      "Currency code for pricing (required for new API, determines default region)",
  ...
  @ApiProperty({
    description:
      "Market region for tax/duty adjustments (optional, defaults based on currency)",
  ...
  @ApiProperty({
    description:
      "Country/region code for local market rates and tax jurisdiction",
