...
export class WalkInCustomerDto {
  ...
  @IsNotEmpty()
  @Matches(/^\+\d{1,4}$/, {
    message: "Invalid country code format. Use format like +91, +977",
  })
...
export class CreateShopQuoteDto {
  @ApiProperty({
    ...
    description: "Walk-in customer details",
  })
  @ValidateNested()
  @Type(() => WalkInCustomerDto)
...
export class UpdateQuoteStatusDto {
  ...
  @ApiPropertyOptional({
    description: "Reason for cancellation (required if cancelling)",
  })
  @IsOptional()
  @IsString()
  cancelReason?: string;
