...
async function main() {
  ...
  const existingShop1 = await prisma.shop.findFirst({
  ...
  const shop1 =
    ...
    (await prisma.shop.create({
      data: {
        ...
        description:
          "Premium gold jewellery crafted with generations of expertise. Specializing in traditional Nepali designs and modern pieces.",
        descriptionNe:
          "पुस्तौं देखिको विशेषज्ञताले निर्मित प्रिमियम सुनको गहना। परम्परागत नेपाली डिजाइन र आधुनिक टुक्राहरूमा विशेषज्ञता।",
  ...
  const shop2 =
    ...
    (await prisma.shop.create({
      data: {
        ...
        description:
          "Modern designs at competitive prices. Quick turnaround on custom orders.",
        descriptionNe:
          "प्रतिस्पर्धी मूल्यमा आधुनिक डिजाइनहरू। आदेशहरूमा छिटो काम।",
  ...
  await prisma.marketRate.createMany({
    ...
    data: [
      ...
      {
        metalCode: "SILVER_999",
        country: "NP",
        ratePerGram: 130,
        source: "NEPAL_RASTRA_BANK",
      },
      {
        metalCode: "SILVER_925",
        country: "NP",
        ratePerGram: 120,
        source: "CALCULATED",
      },
      {
        metalCode: "PLATINUM_950",
        country: "NP",
        ratePerGram: 4100,
      ...
      {
        metalCode: "STAINLESS_STEEL_316L",
        country: "NP",
        ratePerGram: 0.5,
        source: "LOCAL_MARKET",
      },
  ...
  const ringTemplate1 = await prisma.jewelleryTemplate.upsert({
    ...
    create: {
      ...
      descriptionEn:
        "Timeless single-stone ring design perfect for engagement or everyday wear",
      lightWeightMin: 2.0,
      lightWeightMax: 3.5,
      mediumWeightMin: 3.5,
      mediumWeightMax: 5.5,
  ...
  const ringTemplate2 = await prisma.jewelleryTemplate.upsert({
    where: {
      jewelleryType_nameEn: { jewelleryType: "RING", nameEn: "Band Ring" },
    },
    update: {},
    create: {
      jewelleryType: "RING",
      ...
      nameNe: "ब्यान्ड औंठी",
      descriptionEn:
        "Simple elegant band ring, perfect for wedding bands or stacking",
      lightWeightMin: 1.5,
      lightWeightMax: 2.5,
      mediumWeightMin: 2.5,
      mediumWeightMax: 4.0,
  ...
  const necklaceTemplate = await prisma.jewelleryTemplate.upsert({
    ...
    create: {
      ...
      descriptionEn:
        "Classic Nepali bridal necklace with intricate traditional patterns",
      lightWeightMin: 15.0,
      lightWeightMax: 25.0,
  ...
  const pendantTemplate = await prisma.jewelleryTemplate.upsert({
    ...
    create: {
      ...
      descriptionEn:
        "Contemporary pendant design suitable for casual and formal wear",
      lightWeightMin: 1.5,
      lightWeightMax: 3.0,
      mediumWeightMin: 3.0,
      mediumWeightMax: 5.0,
  ...
  await prisma.gemstonePreset.createMany({
    ...
    data: [
      ...
      },
      {
        ...
        settingStyle: "PRONG",
        sizeOptions: [
          { label: "Small (3mm)", sizeMm: 3, caratWeight: 0.1, priceNpr: 8000 },
          {
            label: "Medium (4mm)",
            sizeMm: 4,
            caratWeight: 0.25,
      ...
      },
      {
        ...
        sizeOptions: [
          ...
          { label: "Medium (5mm)", sizeMm: 5, caratWeight: 0.5, priceNpr: 350 },
          { label: "Large (6mm)", sizeMm: 6, caratWeight: 0.8, priceNpr: 500 },
          {
            label: "Statement (8mm)",
            sizeMm: 8,
            caratWeight: 1.5,
      ...
      },
      {
        ...
        settingStyle: "PRONG",
        sizeOptions: [
          { label: "Small (5mm)", sizeMm: 5, caratWeight: 0.5, priceNpr: 1500 },
          {
            label: "Medium (7mm)",
            sizeMm: 7,
            caratWeight: 1.0,
          ...
          { label: "Large (9mm)", sizeMm: 9, caratWeight: 2.0, priceNpr: 5500 },
        ],
    ...
    data: [
      {
        ...
        tier: "LIGHT",
        nameEn: "Light Gold Plating (0.5-1μm)",
        thicknessMin: 0.5,
        thicknessMax: 1.0,
        basePriceNpr: 500,
        durabilityMonths: 6,
      },
      {
        platingType: "GOLD_PLATING",
        tier: "STANDARD",
        nameEn: "Standard Gold Plating (1-2.5μm)",
        thicknessMin: 1.0,
        thicknessMax: 2.5,
        basePriceNpr: 1000,
        durabilityMonths: 12,
      },
      {
        platingType: "GOLD_PLATING",
        tier: "PREMIUM",
        nameEn: "Premium Gold Plating (2.5-5μm)",
        thicknessMin: 2.5,
        thicknessMax: 5.0,
        basePriceNpr: 2000,
        durabilityMonths: 24,
      ...
      {
        platingType: "ROSE_GOLD_PLATING",
        tier: "LIGHT",
        nameEn: "Light Rose Gold Plating",
        thicknessMin: 0.5,
        thicknessMax: 1.0,
        basePriceNpr: 600,
        durabilityMonths: 6,
      },
      {
        platingType: "ROSE_GOLD_PLATING",
        tier: "STANDARD",
        nameEn: "Standard Rose Gold Plating",
        thicknessMin: 1.0,
        thicknessMax: 2.5,
        basePriceNpr: 1200,
        durabilityMonths: 12,
      },
      {
        platingType: "ROSE_GOLD_PLATING",
        tier: "PREMIUM",
        nameEn: "Premium Rose Gold Plating",
        thicknessMin: 2.5,
        thicknessMax: 5.0,
        basePriceNpr: 2400,
        durabilityMonths: 24,
      ...
      {
        platingType: "RHODIUM_PLATING",
        tier: "LIGHT",
        nameEn: "Light Rhodium Plating",
        thicknessMin: 0.25,
        thicknessMax: 0.5,
        basePriceNpr: 400,
        durabilityMonths: 12,
      },
      {
        platingType: "RHODIUM_PLATING",
        tier: "STANDARD",
        nameEn: "Standard Rhodium Plating",
        thicknessMin: 0.5,
        thicknessMax: 1.0,
        basePriceNpr: 800,
        durabilityMonths: 24,
      },
      {
        platingType: "RHODIUM_PLATING",
        tier: "PREMIUM",
        nameEn: "Premium Rhodium Plating",
        thicknessMin: 1.0,
        thicknessMax: 2.0,
        basePriceNpr: 1500,
        durabilityMonths: 36,
      },
      {
        ...
        descriptionEn: "Requires Sterling Silver base",
        thicknessMin: 2.5,
        thicknessMax: 5.0,
        basePriceNpr: 1800,
        durabilityMonths: 24,
      },
      {
        platingType: "VERMEIL",
        tier: "PREMIUM",
        nameEn: "Premium Vermeil",
        descriptionEn: "Thick gold layer over Sterling Silver",
        thicknessMin: 5.0,
        thicknessMax: 10.0,
        basePriceNpr: 3500,
        durabilityMonths: 36,
      ...
      {
        platingType: "PVD_COATING",
        tier: "STANDARD",
        nameEn: "PVD Gold Coating",
        thicknessMin: 0.5,
        thicknessMax: 2.0,
        basePriceNpr: 1500,
        durabilityMonths: 36,
  ...
  await prisma.marketConfig.upsert({
    ...
    create: {
      ...
      heroSubheadline:
        "Shop from verified jewellers across India. Buy ready-made or custom-crafted jewellery with confidence.",
  ...
  await prisma.marketConfig.upsert({
    ...
    create: {
      ...
      heroSubheadline:
        "Discover unique pieces crafted by skilled jewellers. From custom designs to ready-to-wear collections.",
  ...
  await prisma.marketConfig.upsert({
    ...
    create: {
      ...
      heroSubheadline:
        "Browse collections from verified British and international jewellers. Quality guaranteed.",
  ...
  await prisma.marketConfig.upsert({
    ...
    create: {
      ...
      heroSubheadline:
        "Connect with master craftsmen across Europe. From classic designs to modern masterpieces.",
  ...
  await prisma.marketConfig.upsert({
    ...
    create: {
      ...
      heroSubheadline:
        "Experience the finest gold and diamond jewellery from Dubai's renowned craftsmen.",
  ...
  const taxRules = [
    ...
    },
    {
      ...
      rate: 0.13,
      priority: 3,
      description: "13% VAT on gemstones & diamonds",
    },
    {
      marketRegion: "NP",
      taxType: "LUXURY_TAX",
    ...
    // ── India ──
    {
      ...
      rate: 0.03,
      priority: 1,
      description: "3% GST on precious metal",
    },
    {
      marketRegion: "IN",
      taxType: "GST",
      ...
      rate: 0.05,
      priority: 2,
      description: "5% GST on making charges (service)",
    },
    {
      marketRegion: "IN",
      taxType: "GST",
      ...
      rate: 0.03,
      priority: 3,
      description: "3% GST on gemstones",
    },
    {
      marketRegion: "IN",
      taxType: "GST",
      ...
      rate: 0.18,
      priority: 4,
      description: "18% GST on finish/plating (service)",
    },
    // ── UAE ──
    {
      marketRegion: "AE",
      ...
      rate: 0.05,
      priority: 1,
      description: "5% VAT on all components",
    },
    // ── UK ──
    {
      marketRegion: "UK",
      ...
      rate: 0.2,
      priority: 1,
      description: "20% VAT on all components",
    },
    // ── EU ──
    {
      marketRegion: "EU",
  ...
  for (const rule of taxRules) {
    await prisma.taxRuleConfig.upsert({
      where: {
        id: `seed-${rule.marketRegion}-${rule.category}-${rule.taxName.replace(/\s/g, "_")}`,
      },
      update: {
        rate: rule.rate,
      ...
      create: {
        id: `seed-${rule.marketRegion}-${rule.category}-${rule.taxName.replace(/\s/g, "_")}`,
        marketRegion: rule.marketRegion as any,
        taxType: rule.taxType,
