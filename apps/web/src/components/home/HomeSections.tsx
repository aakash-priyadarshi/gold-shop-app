...
const shopFeatures = [
  { icon: LayoutDashboard, title: "Smart Dashboard", desc: "Real-time analytics, sales tracking, and inventory management in one clean interface." },
  { icon: Package, title: "Inventory & Catalogue", desc: "Upload products with photos, set pricing by weight, manage stock with barcode/SKU support." },
  { icon: MessageSquare, title: "Built-in Chat & RFQ", desc: "Receive custom order requests, chat with buyers in real-time, and send quotes instantly." },
  { icon: Globe, title: "International Reach", desc: "Your shop is visible to buyers in 5+ countries. Multi-currency pricing handled automatically." },
  { icon: BarChart3, title: "Sales Analytics", desc: "Track revenue, popular products, customer demographics, and conversion rates." },
  { icon: Zap, title: "Zero Setup Cost", desc: "Get started in minutes. No technical knowledge needed. We handle hosting, security & updates." },
];
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-10 lg:mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm lg:text-base">
              <T>We connect you with verified jewellers across Nepal, India, Dubai, USA & UK who craft authentic, high-quality pieces with complete transparency.</T>
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8">
            {features.map((f, i) => (
              <div key={i} className={`premium-card p-6 lg:p-8 ${i === 2 ? "sm:col-span-2 lg:col-span-1" : ""}`}>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm lg:text-lg">
              <T>Take your jewellery business online with powerful CMS. Manage inventory, accept orders, and reach buyers across Nepal, India, Dubai, USA & UK — all from one dashboard.</T>
            </p>
            <Link
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 lg:mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2 max-w-lg mx-auto text-sm lg:text-base">
              <T>Practical resources to help jewellery businesses grow online and optimise their operations.</T>
            </p>
          </div>
      ...
      <section className="py-12 lg:py-20 gold-gradient relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative">
          ...
          <p className="text-gold-100 mb-6 lg:mb-8 max-w-xl mx-auto text-sm lg:text-base">
            {t(`Join hundreds of verified jewellers across Nepal, India, Dubai, USA & UK who are selling on ${BRAND.name}. List your shop for free and start receiving orders today.`)}
          </p>
