...
export const GOLD_KARATS_METHOD_B = [
  {
    ...
    purity: 0.917,
    tooltip:
      "Very high gold content. Slightly softer than lower karats. Rich, deep gold color.",
    rateKey: "GOLD_22K",
  },
  {
    value: "18K",
    ...
    purity: 0.75,
    tooltip:
      "Perfect balance of purity and durability. Industry standard for fine jewellery.",
    rateKey: "GOLD_18K",
  },
  {
    value: "14K",
    ...
    purity: 0.583,
    tooltip:
      "Excellent durability. Popular in US market. Great for everyday wear.",
    rateKey: "GOLD_14K",
  },
  {
    value: "10K",
    ...
    purity: 0.417,
    tooltip:
      "Most durable gold alloy. Affordable entry point. Lighter gold color.",
    rateKey: "GOLD_10K",
  },
] as const;
...
export const SILVER_PURITIES = [
  {
    ...
    purity: 0.925,
    tooltip:
      "Classic silver alloy. 92.5% silver with copper for strength. May tarnish over time.",
    rateKey: "SILVER_925",
  },
  {
    value: "ARGENTIUM_935",
    ...
    purity: 0.935,
    tooltip:
      "Premium tarnish-resistant silver. Contains germanium. Better for sensitive skin.",
...
export const ALLOY_FAMILIES = [
  ...
  },
  {
    ...
    tooltip: {
      ...
      maintenance:
        "May need rhodium re-plating every 1-2 years to maintain bright white color.",
...
export const ALLOY_COMPONENTS = [
  ...
  },
  {
    ...
    tooltip:
      "Creates bright white color. Nickel-free, hypoallergenic. Premium cost.",
  ...
  },
  {
    ...
    tooltip:
      "Traditional white gold alloy. May cause allergic reactions. Banned in EU for skin contact.",
    useInFamilies: ["WHITE_GOLD"],
    allergyRisk: "HIGH",
    isRestricted: true,
    restrictionNote:
      "Not recommended. Only available where nickel compliance is enabled.",
  },
] as const;
...
export const ALLOY_RECIPE_PRESETS: AlloyRecipePreset[] = [
  // 18K Yellow Gold
  {
    ...
    priceMultiplier: 1.0,
    tooltip:
      "Industry standard 18K yellow gold. Perfect balance of color and durability. Most popular choice.",
  ...
  },
  {
    ...
    tooltip:
      "Higher copper content for richer color and better durability. Slightly warmer tone.",
    nickelCompliant: true,
  },
  ...
  // 18K Rose Gold
  {
    ...
    tooltip:
      "Popular rose gold formula. Beautiful pink hue that flatters all skin tones.",
    nickelCompliant: true,
  },
  {
    id: "18K_ROSE_DEEP",
    ...
    components: [{ metal: "COPPER", percentage: 25 }],
    characteristics: {
    ...
    tooltip:
      "Maximum copper content for deepest rose color. Extremely durable.",
    nickelCompliant: true,
  },
  ...
  // 18K White Gold
  {
    ...
    priceMultiplier: 1.1, // Premium for palladium
    tooltip:
      "Hypoallergenic white gold using palladium. Premium choice for sensitive skin. May need occasional rhodium plating.",
    nickelCompliant: true,
  },
  {
    id: "18K_WHITE_NICKEL",
    ...
    priceMultiplier: 1.03,
    tooltip:
      "⚠️ Contains nickel - may cause allergic reactions. Not available in EU countries. Brighter white color than palladium.",
  ...
  // 14K Options
  {
    ...
    priceMultiplier: 1.0,
    tooltip:
      "Popular in USA. Great durability for everyday wear. More affordable than 18K.",
    nickelCompliant: true,
  },
  {
    ...
    priceMultiplier: 1.01,
    tooltip:
      "Higher copper ratio makes this very durable. Deeper rose color than 18K.",
    nickelCompliant: true,
  },
  {
    ...
    tooltip:
      "Nickel-free white gold at 14K price point. Great balance of affordability and hypoallergenic properties.",
    nickelCompliant: true,
  },
  ...
  // 10K Options
  {
    ...
    priceMultiplier: 1.0,
    tooltip:
      "Entry-level gold. Extremely durable. Lighter gold color. Budget-friendly option.",
    nickelCompliant: true,
  },
  ...
  // 22K Options
  {
    ...
    priceMultiplier: 1.0,
    tooltip:
      "Traditional South Asian & Middle Eastern choice. Very soft - best for special occasion wear.",
    nickelCompliant: true,
  },

  // Green Gold (Electrum) Options
  {
    id: "18K_GREEN_STANDARD",
    family: "GREEN_GOLD",
    karat: "18K",
    name: "18K Green Gold (Standard)",
    description: "Classic greenish-yellow gold",
    components: [{ metal: "SILVER", percentage: 25 }],
    characteristics: {
      durability: "MEDIUM",
      colorTone: "Subtle yellow-green",
      allergyRisk: "NONE",
      maintenanceLevel: "LOW",
    },
    priceMultiplier: 1.02,
    tooltip:
      "Traditional Electrum alloy. Pure silver alloyed with gold creates a subtle greenish tint. Hypoallergenic and unique.",
    nickelCompliant: true,
  },
  {
    id: "18K_GREEN_DEEP",
    family: "GREEN_GOLD",
    karat: "18K",
    name: "18K Green Gold (Deep)",
    description: "More pronounced green tint",
    components: [
      { metal: "SILVER", percentage: 23 },
      { metal: "ZINC", percentage: 2 },
    ],
    characteristics: {
      durability: "MEDIUM",
      colorTone: "More pronounced green",
      allergyRisk: "LOW",
      maintenanceLevel: "LOW",
    },
    priceMultiplier: 1.03,
    tooltip:
      "Enhanced green color with zinc addition. Slightly more pronounced greenish hue than standard.",
    nickelCompliant: true,
  },
  {
    id: "14K_GREEN_STANDARD",
    family: "GREEN_GOLD",
    karat: "14K",
    name: "14K Green Gold (Standard)",
    description: "Durable green-tinted gold",
    components: [{ metal: "SILVER", percentage: 41.7 }],
    characteristics: {
      durability: "HIGH",
      colorTone: "Noticeable yellow-green",
      allergyRisk: "NONE",
      maintenanceLevel: "LOW",
    },
    priceMultiplier: 1.01,
    tooltip:
      "Higher silver content creates a more noticeable green tint. More durable than 18K. Great for everyday wear.",
    nickelCompliant: true,
  },
] as const;
 ...
 */
export function getAvailableFamiliesForKarat(
  karat: GoldKarat,
): (typeof ALLOY_FAMILIES)[number][] {
  return ALLOY_FAMILIES.filter((f) =>
    (f.availableKarats as readonly string[]).includes(karat),
  );
}
...
export function getRecipePresets(
  ...
  return ALLOY_RECIPE_PRESETS.filter(
    (r) =>
      r.family === family &&
      r.karat === karat &&
