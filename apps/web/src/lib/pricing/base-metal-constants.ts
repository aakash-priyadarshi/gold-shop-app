...
export const BASE_METALS: BaseMetal[] = [
  {
    ...
    tooltip: {
      ...
      allergyRisk:
        "May cause reactions in sensitive individuals due to copper/zinc.",
  ...
  },
  {
    ...
    tooltip: {
      ...
      durability:
        "Soft metal. Will develop green patina (verdigris) over time.",
  ...
  },
  {
    ...
    tooltip: {
      ...
      allergyRisk:
        "Hypoallergenic. Safe for most people including those with metal sensitivities.",
      bestFor:
        "Everyday wear, men's jewellery, body jewellery, active lifestyles.",
    },
    allergyRisk: "NONE",
    nickelRequired: false,
  },
  {
    ...
    tooltip: {
      ...
      allergyRisk:
        "Contains some nickel. May cause reactions in sensitive individuals.",
  ...
  },
  {
    ...
    tooltip: {
      ...
      allergyRisk:
        "Completely hypoallergenic. Best for severe metal allergies.",
  ...
  },
  {
    ...
    tooltip: {
      ...
      allergyRisk:
        "⚠️ HIGH NICKEL CONTENT. Not suitable for those with nickel allergies.",
...
export const PLATING_OPTIONS: PlatingOption[] = [
  {
    ...
    tooltip: {
      ...
      durability:
        "Typical lifespan: 6 months to 2 years depending on wear and care.",
      care: "Avoid water, perfumes, lotions, and chemicals. Remove before sleeping. Store separately.",
      replatFrequency:
        "Re-plating available every 1-2 years to restore appearance.",
      allergyInfo:
        "Safe if gold layer is intact. May react if plating wears through to base metal.",
      disclaimer:
        "Gold plating wears with friction. Daily wear pieces will fade faster.",
    },
  },
  {
    value: "GOLD_FILLED",
    ...
    tooltip: {
      ...
      durability:
        "Long-lasting: 10-30 years with care. Can last a lifetime if well maintained.",
      care: "More durable than plating. Can get wet occasionally. Polish gently.",
      replatFrequency:
        "Rarely needs re-doing. May need polishing after many years.",
      allergyInfo: "Very safe for sensitive skin due to thick gold layer.",
      disclaimer:
        "Not solid gold, but excellent alternative. Worth the investment for regular wear.",
    },
  },
  {
    value: "VERMEIL",
    ...
    tooltip: {
      ...
      disclaimer:
        "Premium option. Requires sterling silver base - no substitutes.",
    },
  ...
  },
  {
    ...
    tooltip: {
      ...
      durability:
        "Similar to gold plating. Color may fade slightly faster due to copper.",
  ...
  },
  {
    ...
    tooltip: {
      ...
      durability:
        "Very scratch-resistant. Lasts 1-3 years before showing wear.",
      care: "Low maintenance. Avoid harsh chemicals. Professional polishing recommended.",
      replatFrequency:
        "Re-plating every 1-3 years to maintain bright white finish.",
      allergyInfo: "Hypoallergenic. Excellent for sensitive skin.",
      disclaimer:
        "Creates bright white finish. Often used to brighten white gold.",
    },
  },
  {
    value: "PVD_GOLD",
...
export const PLATING_TIERS: PlatingTier[] = [
  {
    ...
    tooltip:
      "Thinnest layer. Best for occasional wear pieces. 3-6 month typical lifespan.",
  },
  {
    value: "STANDARD",
    label: "Standard",
    ...
    tooltip:
      "Recommended. Good balance of cost and durability. 1-2 year typical lifespan.",
  },
  {
    value: "PREMIUM",
    label: "Premium",
    ...
    tooltip:
      "Thickest layer. Best for daily wear. 2-5 year typical lifespan. Worth the investment.",
  },
];
...
export const SURFACE_FINISH_DEFAULTS: Record<
  string,
  { label: string; ratePerPieceNpr: number }
> = {
 ...
 */
export function getPlatingOption(
  value: PlatingTypeC,
): PlatingOption | undefined {
...
export function calculatePlatingCost(
  ...
  return (
    plating.baseRateNpr * tierInfo.multiplier * surfaceFactor * weightFactor
  );
}
...
export function validateMethodC(
  ...
  if (platingType === "VERMEIL") {
    errors.push(
      "Vermeil requires Sterling Silver base - use Method A with vermeil finish instead",
    );
  }
