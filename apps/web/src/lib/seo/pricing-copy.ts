...
export function getRegionalPricingSeo(
  ...
  if (normalized === "IN") {
    return {
      ...
      openGraphDescription:
        "India pricing for Orivraa jewellery software. Free plan available, Pro starts at ₹299/month, with mobile POS, 7-day live rates, GSTIN-ready invoicing, tax reports, AI tools, and marketplace access.",
      twitterTitle: "Orivraa Pricing India | From ₹299/month",
      twitterDescription:
        "Free plan available. India Pro starts at ₹299/month with mobile POS, live rate history, GSTIN-ready invoices, tax reports, and marketplace access.",
      faqCostText:
      ...
      faqProText:
        "In India, Orivraa Pro starts at ₹299/month and includes inventory management by weight and purity, invoicing and billing, mobile POS tools, customer management, bulk upload, analytics, GSTIN-ready invoices, and priority support. Mobile rate-card features help shops check recent gold trends before billing or quoting.",
      faqBestText:
  ...
  if (normalized === "NP") {
    return {
      ...
      twitterDescription:
        "Free plan available. Nepal Pro starts at NPR 399/month with mobile POS, live rate history, billing, tax-ready workflows, and marketplace access.",
      faqCostText:
      ...
      faqProText:
        "In Nepal, Orivraa Pro starts at NPR 399/month and includes inventory management by weight and purity, invoicing and billing, mobile POS workflows, customer management, bulk upload, analytics, and local tax-ready workflows.",
      faqBestText:
  ...
  return {
    ...
    faqProText:
      "Orivraa Pro includes inventory management by weight and purity, invoicing and billing, mobile POS tools, customer management, bulk upload, analytics, GSTIN-ready invoices, and priority support. Pricing is local by country, including India Pro from ₹299/month.",
    faqBestText:
