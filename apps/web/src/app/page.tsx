            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8">
              {[
                ...
                <div key={item.step} className="text-center">
                  ...
                  <h3 className="text-sm lg:text-lg font-semibold text-gray-900 dark:text-white mb-1 lg:mb-2">{item.title}</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-xs lg:text-sm">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-12 lg:py-20 gold-gradient relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link href="/shops">
                <Button size="lg" variant="outline" className="w-full sm:w-auto h-12 px-8 rounded-xl text-base bg-transparent text-white border-white hover:bg-white dark:bg-gray-900 hover:text-gold-600">
                  Browse Sellers
                </Button>
              </Link>
            </div>
