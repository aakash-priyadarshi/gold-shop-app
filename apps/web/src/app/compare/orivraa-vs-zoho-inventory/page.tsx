...
const ROWS: Row[] = [
  { feature: "Built specifically for jewellery shops", orivraa: true, zoho: false },
  { feature: "Weight-based billing (gram, tola, ounce)", orivraa: true, zoho: false },
  { feature: "Live gold & silver rate integration", orivraa: true, zoho: false },
  { feature: "Making charges & wastage calculation", orivraa: true, zoho: false },
  { feature: "Purity tracking (24K, 22K, 18K, hallmark)", orivraa: true, zoho: false },
  { feature: "Old gold exchange & buy-back", orivraa: true, zoho: false },
  { feature: "GST / VAT compliant invoicing", orivraa: true, zoho: true },
  { feature: "Multi-currency support", orivraa: true, zoho: true },
  {
    feature: "Works in India, Nepal, UAE, UK & USA",
    orivraa: true,
    zoho: true,
    note: "Zoho has no jewellery-specific tax or weight logic for any market",
  },
  { feature: "Jewellery POS (counter billing terminal)", orivraa: true, zoho: false },
  { feature: "Custom order (RFQ) & buyer marketplace", orivraa: true, zoho: false },
  { feature: "Barcode / HUID / tag label printing", orivraa: true, zoho: "Via add-on" },
  { feature: "Free plan available", orivraa: true, zoho: "14-day trial only" },
  { feature: "Starting price", orivraa: "Free → ₹299/mo in India", zoho: "₹999/mo+ (India)" },
];
...
export default function OrivraaVsZohoInventoryPage() {
  return (
        ...
        <section className="pt-24 pb-12 bg-gradient-to-b from-amber-50 to-white dark:from-gray-900 dark:to-gray-950">
          <div className="container mx-auto px-4 max-w-5xl text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white tracking-tight mb-6">
              <T>Orivraa vs Zoho Inventory for Jewellery Shops</T>
            </h1>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed mb-8">
              <T>
                Zoho Inventory is a solid general-purpose tool with good GST
                support — but it treats a 22K gold ring the same as a coffee
                mug. It has no concept of weight-based pricing, live metal
                rates, making charges, or jewellery-specific billing. Here&apos;s
                the full comparison.
              </T>
            </p>
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="grid md:grid-cols-3 gap-6">
              {[
                {
                  icon: Zap,
                  title: "Dual-unit tracking by design",
                  desc: "Orivraa tracks every item as both a physical unit AND a weight in grams. Zoho only tracks unit count — so you lose accuracy the moment you price anything by weight.",
                },
                {
                  icon: Globe,
                  title: "Live commodity pricing",
                  desc: "Gold and silver prices update daily from market feeds. Zoho requires you to manually update every item price when rates change — impractical for a shop with hundreds of SKUs.",
                },
                {
                  icon: Cloud,
                  title: "Counter POS + marketplace",
                  desc: "Orivraa includes a POS billing terminal and a buyer marketplace. Zoho Inventory is a back-office tool — it has no customer-facing storefront or POS equivalent.",
                },
              ].map((p) => {
                const Icon = p.icon;
                return (
        ...
        <section className="py-16 bg-white dark:bg-gray-900">
          <div className="container mx-auto px-4 max-w-3xl">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-6">
              <T>When Zoho Inventory is still the right choice</T>
            </h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              <T>
                Zoho Inventory is a strong choice if you are already deep in the
                Zoho ecosystem — using Zoho Books for accounting, Zoho CRM for
                customers, or Zoho Commerce for your website. The integration
                between Zoho apps is genuinely seamless and the combined stack
                is hard to beat for general B2B businesses.
              </T>
            </p>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              <T>
                But if your products are priced by weight and purity rather than
                a fixed SKU price, and you need a counter POS that calculates
                a 22K ring price from today&apos;s gold rate, Zoho Inventory
                simply isn&apos;t designed for that workflow.
              </T>
            </p>
          </div>
        </section>
