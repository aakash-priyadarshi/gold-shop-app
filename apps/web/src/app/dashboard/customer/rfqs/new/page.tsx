  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isPhoneVerified) {
      toast({
        ...
        description:
          "Please verify your phone number before submitting a quote request.",
      });
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="jewelleryType">
                    <T>Type of Jewellery *</T>
                  </Label>
                  <Select
                    value={formData.jewelleryType}
                    onValueChange={(value) =>
                      handleInputChange("jewelleryType", value)
                    }
                  >
                    <SelectTrigger>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleInputChange("purity", value)
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                      ...
                      <SelectContent>
                        {purities[
                          formData.metalType as keyof typeof purities
                        ]?.map((p) => (
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    <T>
                      Enter your estimated weight, shops may adjust in their
                      offer
                    </T>
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("preferredDeliveryDays", e.target.value)
                    }
                  />
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 rounded-lg p-4 flex gap-3">
                  ...
                  <div className="text-sm text-blue-800 dark:text-blue-200">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-blue-700 dark:text-blue-300">
                      ...
                      <li>
                        <T>You can compare offers and choose the best one</T>
                      </li>
                      <li>
                        <T>No commitment until you accept an offer</T>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    <Phone
                      className={`h-5 w-5 ${isPhoneVerified ? "text-green-600" : "text-amber-600"}`}
                    />
                    <div>
                      <p
