...
function PlatformSelector({
  ...
  return (
    <div className="relative inline-flex items-center gap-1.5 p-1.5 rounded-full bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 backdrop-blur-md">
      {platforms.map((p) => (
        <button
          key={p}
          onClick={() => onSelect(p)}
          className={`relative px-5 py-2.5 text-xs font-semibold rounded-full transition-all z-10 duration-300 ${
            selected === p
              ? "text-gray-950 shadow-md shadow-gold-500/20"
...
// The mockup interior stays dark (it shows the real app UI which is dark-themed).
// The frame around it adapts to light/dark mode.
  ...
  return (
    <div className="perspective-1000 w-full flex justify-center">
      <motion.div
        ...
        className="relative w-full max-w-xl aspect-[16/10.5] rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-2xl shadow-gold-500/10 overflow-hidden transition-all duration-300 ease-out select-none group ring-1 ring-gray-900/5 dark:ring-white/5"
      >
        {/* The app interior is always dark — it shows the real Orivraa desktop app UI */}
  ...
  return (
    <div className="h-full flex flex-col justify-between">
      <div className="flex items-center justify-between pb-3 border-b border-gray-200 dark:border-gray-800">
        <span className="text-xs font-semibold text-gold-600 dark:text-gold-400 flex items-center gap-1.5">
      ...
      <div className="relative py-6 flex justify-around items-center h-28 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-800 my-4 overflow-hidden">
        ...
        <div className="z-10 flex flex-col items-center gap-1">
          <div className="w-10 h-10 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center shadow-lg">
            <ComputerDesktopIcon className="w-5 h-5 text-gray-700 dark:text-gray-200" />
          </div>
          <span className="text-[10px] font-medium text-gray-500 dark:text-gray-400"><T>Local POS App</T></span>
        </div>

        <div className="z-10 flex flex-col items-center gap-1">
          <div className="w-10 h-10 rounded-lg border flex items-center justify-center shadow-lg transition-colors bg-white dark:bg-gray-800 border-gray-200 dark:border-gold-500/30">
            <ServerIcon className={`w-5 h-5 ${offline ? "text-gray-400 dark:text-gray-500" : "text-gold-500"}`} />
          </div>
          <span className="text-[10px] font-medium text-gray-500 dark:text-gray-400"><T>Orivraa Cloud</T></span>
        </div>
      </div>
  ...
  return (
    <div className="h-full flex flex-col justify-between">
      <div className="flex items-center gap-1.5 pb-2">
        ...
        <span className="text-xs font-semibold text-gold-600 dark:text-gold-400"><T>USB weighing scale sync</T></span>
      </div>

      {/* Hardware readout stays dark — it mimics a real LCD scale display */}
      <div className="my-3 p-4 rounded-xl bg-gray-900 dark:bg-black border border-gold-500/25 flex flex-col items-center gap-1.5 font-mono shadow-inner shadow-gold-500/5">
        <p className="text-[10px] text-gray-400 tracking-wider uppercase font-semibold"><T>Hardware Weight Readout</T></p>
  ...
  return (
    <div className="h-full flex flex-col justify-between">
      <div className="flex items-center justify-between pb-3 border-b border-gray-200 dark:border-gray-800">
        ...
        <div className="flex gap-1 bg-gray-100 dark:bg-gray-900 p-1 rounded-md border border-gray-200 dark:border-gray-800">
      ...
      <div className="my-3 p-3.5 rounded-xl bg-gray-50 dark:bg-gray-900/70 border border-gray-200 dark:border-gray-800 text-left font-mono space-y-1.5">
        <div className="flex justify-between text-[9px] text-gray-500 dark:text-gray-400 border-b border-gray-200 dark:border-gray-800 pb-1">
          <span><T>Metal + Making Value</T></span>
          <span>₹110,000</span>
        </div>
        {regime === "IN" && (
          <>
            <div className="flex justify-between text-[9px] text-gray-700 dark:text-gray-200">
              <span><T>GST on Gold Metal (3%)</T></span>
              <span className="text-gold-600 dark:text-gold-400">₹3,000</span>
            </div>
            <div className="flex justify-between text-[9px] text-gray-700 dark:text-gray-200">
              <span><T>GST on Making Charges (5%)</T></span>
              <span className="text-gold-600 dark:text-gold-400">₹500</span>
            </div>
          </>
        )}
        {regime === "NP" && (
          <>
            <div className="flex justify-between text-[9px] text-gray-700 dark:text-gray-200">
              ...
              <span className="text-gold-600 dark:text-gold-400">₹550</span>
            </div>
            <div className="flex justify-between text-[9px] text-gray-700 dark:text-gray-200">
              <span><T>VAT on Gems Content (13%)</T></span>
              <span className="text-gold-600 dark:text-gold-400">₹0</span>
            </div>
          </>
        )}
        {regime === "AE" && (
          <>
            <div className="flex justify-between text-[9px] text-gray-700 dark:text-gray-200">
              <span><T>VAT on All Components (5%)</T></span>
              <span className="text-gold-600 dark:text-gold-400">₹5,500</span>
            </div>
          </>
        )}
        <div className="flex justify-between text-[9px] font-bold text-gray-900 dark:text-white border-t border-gray-200 dark:border-gray-800 pt-1">
          <span><T>Calculated Tax Amount</T></span>
          <span className="text-gold-600 dark:text-gold-400">
            {regime === "IN" ? "₹3,500" : regime === "NP" ? "₹550" : "₹5,500"}
          </span>
        </div>
      </div>
...
function InstallationGuide() {
  ...
  return (
    <Card className="border-gray-200 dark:border-gray-800 shadow-xl shadow-gold-500/5 bg-white dark:bg-gray-900 overflow-hidden relative">
      <div className="absolute top-0 right-0 w-64 h-64 bg-gold-500/5 rounded-full blur-3xl" />

      <CardHeader className="border-b border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4 py-6 px-6">
        <div>
        ...
        <div className="flex gap-1.5 bg-gray-100 dark:bg-gray-800 p-1.5 rounded-full border border-gray-200 dark:border-gray-700 shrink-0">
      ...
      <CardContent className="py-8 px-6 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {guideTab === "WINDOWS" ? (
              <>
                <div className="flex gap-4">
                  <div className="w-7 h-7 rounded-full bg-gold-500/10 border border-gold-500/20 text-gold-600 dark:text-gold-400 flex items-center justify-center font-bold text-sm shrink-0">
                    1
                  </div>
                  <div>
                    <h4 className="font-bold text-sm text-gray-900 dark:text-white mb-1"><T>Download the installer</T></h4>
                    <p className="text-xs text-gray-500 dark:text-gray-400"><T>Click the "Download for Windows" button above to download the Windows installer file.</T></p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-gray-900 dark:text-white mb-1"><T>Bypass SmartScreen</T></h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-gray-900 dark:text-white mb-1"><T>Run & Autoupdate</T></h4>
                    <p className="text-xs text-gray-500 dark:text-gray-400"><T>Orivraa will configure, launch and place a shortcut on your desktop automatically. Updates will download silently in the background.</T></p>
                  </div>
                </div>
              </>
            ) : (
              <>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-gray-900 dark:text-white mb-1"><T>Download and open .dmg</T></h4>
                    <p className="text-xs text-gray-500 dark:text-gray-400"><T>Click the "Download for macOS" button to save the dmg file, then double-click to mount the disk image.</T></p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-gray-900 dark:text-white mb-1"><T>Drag to Applications</T></h4>
                    <p className="text-xs text-gray-500 dark:text-gray-400"><T>Drag the Orivraa icon directly into your Applications folder as prompted inside the window.</T></p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-gray-900 dark:text-white mb-1"><T>Authorize Gatekeeper alert</T></h4>
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      <T>
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 p-5 flex flex-col justify-center items-center gap-4 text-center">
            {guideTab === "WINDOWS" ? (
              <>
                <div className="w-16 h-16 rounded-2xl bg-gold-500/10 flex items-center justify-center border border-gold-500/20 shadow-md">
                  <ShieldExclamationIcon className="w-8 h-8 text-gold-500 dark:text-gold-400" />
                </div>
                <div className="space-y-1.5 max-w-sm">
                  <p className="font-bold text-sm text-gray-900 dark:text-white"><T>SmartScreen Warning Help</T></p>
              ...
              <>
                <div className="w-16 h-16 rounded-2xl bg-gold-500/10 flex items-center justify-center border border-gold-500/20 shadow-md">
                  <LockClosedIcon className="w-8 h-8 text-gold-500 dark:text-gold-400" />
                </div>
                <div className="space-y-1.5 max-w-sm">
                  <p className="font-bold text-sm text-gray-900 dark:text-white"><T>Gatekeeper Block Help</T></p>
                  <p className="text-[11px] text-gray-500 dark:text-gray-400 leading-relaxed">
                    <T>
...
function OlderVersionRow({ release, index }: { release: Release; index: number }) {
  ...
  return (
    <ScrollReveal direction="left" delay={index * 0.05} spring={false} duration={0.3} once>
      <div className="flex items-center justify-between p-4 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-gold-500/30 hover:bg-gold-500/5 transition-all duration-200 group">
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white overflow-x-hidden">
        ...
        <section ref={heroRef} className="relative overflow-hidden pt-28 pb-20 md:pt-36 md:pb-28 border-b border-gray-100 dark:border-gray-900 bg-white dark:bg-gray-950">

          {/* Subtle decorative gradients (matching home/about page style) */}
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 flex flex-col items-center lg:items-start text-center lg:text-left">
                ...
                <ScrollReveal direction="up" delay={0.12} spring once>
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 leading-tight max-w-xl text-gray-900 dark:text-white">
                ...
                <ScrollReveal direction="up" delay={0.2} spring once>
                  <p className="text-base text-gray-600 dark:text-gray-300 max-w-lg mb-6 leading-relaxed">
                    <T>
                ...
                <ScrollReveal direction="up" delay={0.26} spring once>
                ...
                {/* Platform selector */}
                <ScrollReveal direction="up" delay={0.3} spring once>
                  <div className="mb-6">
                ...
                <ScrollReveal direction="up" delay={0.34} spring once>
                  <div className="w-full max-w-md space-y-4">
                    {loading ? (
                      <div className="h-16 w-full rounded-2xl bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 flex items-center justify-center gap-3">
                        <div className="w-5 h-5 rounded-full border-2 border-transparent border-t-gold-500 border-r-gold-300 animate-spin" />
                        <span className="text-xs text-gray-500 dark:text-gray-400"><T>Retrieving active build installer...</T></span>
                      </div>
                    ) : downloadUrl ? (
                      <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                        <Button
                          ...
                          className="w-full bg-gradient-to-r from-gold-400 via-gold-500 to-gold-600 hover:from-gold-500 hover:to-gold-700 text-gray-950 font-bold py-7 text-base rounded-2xl gap-3 shadow-xl shadow-gold-500/20 border border-gold-300/30 transition-all"
                        >
                          {downloading ? (
                      ...
                      <div className="w-full p-4 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-center space-y-2">
                    ...
                    {primaryRelease && !loading && (
                      <div className="flex justify-between items-center text-[10px] text-gray-400 dark:text-gray-500 px-2 font-mono">
                    ...
                    <div className="p-4 rounded-xl border border-emerald-200 dark:border-emerald-500/20 bg-emerald-50 dark:bg-emerald-500/5 text-emerald-800 dark:text-emerald-400 text-xs leading-relaxed text-left flex items-start gap-3 shadow-sm">
                    ...
                    {primaryRelease && (
                      <div className="flex justify-center pt-2">
                        <a
                          ...
                          className="text-xs text-gray-500 dark:text-gray-400 hover:text-gold-600 dark:hover:text-gold-400 transition-colors underline underline-offset-4 flex items-center gap-1.5 font-semibold"
                        >
            ...
            {!loading && latestReleases.length > 0 && (
              <ScrollReveal direction="up" delay={0.6} spring once>
                <div className="flex flex-wrap justify-center gap-8 md:gap-12 mt-16 text-center border-t border-gray-100 dark:border-gray-900 pt-8">
                  {[
                    ...
                    <div key={i}>
                      <p className="text-lg md:text-xl font-bold bg-gradient-to-r from-gold-600 to-gold-800 dark:from-gold-300 dark:to-gold-500 bg-clip-text text-transparent">
                        <T>{stat.value}</T>
                      </p>
          ...
          <section className="py-16 border-b border-gray-100 dark:border-gray-900 bg-gray-50 dark:bg-gray-950">
            <div className="container mx-auto px-4 max-w-3xl">
              <ScrollReveal direction="up" spring once>
                <h2 className="text-2xl font-bold text-center mb-10 tracking-tight text-gray-900 dark:text-white">
                  <T>System Requirements</T>
                </h2>
              </ScrollReveal>
              <ScrollReveal direction="up" delay={0.1} staggerChildren={0.1} spring once>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                  <div className="border border-gray-200 dark:border-gray-800 hover:border-gold-500/30 transition-all rounded-2xl bg-white dark:bg-gray-900 p-6 flex flex-col items-center gap-3 shadow-sm">
                    ...
                    <p className="font-bold text-sm text-gray-900 dark:text-white"><T>Operating System</T></p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 text-center">{primaryRelease.minOs || "Windows 10+ / macOS 12+"}</p>
                  </div>
                  ...
                  <div className="border border-gray-200 dark:border-gray-800 hover:border-gold-500/30 transition-all rounded-2xl bg-white dark:bg-gray-900 p-6 flex flex-col items-center gap-3 shadow-sm">
                    ...
                    <p className="font-bold text-sm text-gray-900 dark:text-white"><T>Memory</T></p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 text-center">{primaryRelease.minRam || "4 GB RAM"}</p>
                  </div>
                  ...
                  <div className="border border-gray-200 dark:border-gray-800 hover:border-gold-500/30 transition-all rounded-2xl bg-white dark:bg-gray-900 p-6 flex flex-col items-center gap-3 shadow-sm">
                    ...
                    <p className="font-bold text-sm text-gray-900 dark:text-white"><T>Disk Space</T></p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 text-center">{primaryRelease.minDisk || "200 MB"}</p>
                  </div>
                </div>
              </ScrollReveal>
            </div>
        ...
        {/* ═══ Bento Grid Features ═══ */}
        <section className="py-24 border-b border-gray-100 dark:border-gray-900 bg-white dark:bg-gray-950">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <ScrollReveal direction="up" staggerChildren={0.1} spring once>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Bento Card 1: Offline Sync (Wide) */}
                <div className="md:col-span-2 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 flex flex-col justify-between hover:border-gold-500/30 hover:shadow-lg hover:shadow-gold-500/5 transition-all duration-300 text-left min-h-[250px]">
                  <BentoSyncShowcase />
                </div>

                {/* Bento Card 2: Scale sync (Square) */}
                <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 flex flex-col justify-between hover:border-gold-500/30 hover:shadow-lg hover:shadow-gold-500/5 transition-all duration-300 text-left min-h-[250px]">
                  <BentoScaleShowcase />
                </div>

                {/* Bento Card 3: Barcode lookup (Square) */}
                <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 flex flex-col justify-between hover:border-gold-500/30 hover:shadow-lg hover:shadow-gold-500/5 transition-all duration-300 text-left min-h-[250px] group">
                  <div className="flex items-center gap-1.5 pb-2">
                  ...
                  <div className="relative my-3 p-4 rounded-xl bg-gray-50 dark:bg-gray-900/80 border border-gray-200 dark:border-gray-800 overflow-hidden flex flex-col justify-center items-center h-28">
                    {/* Sweep scan bar */}
                    ...
                    <div className="w-16 h-10 border-x border-gray-300 dark:border-gray-700 relative flex gap-0.5 justify-around items-end px-1 opacity-70">
                      {[16, 28, 20, 32, 12, 24, 28, 16, 8, 30].map((h, i) => (
                        <div key={i} className="w-0.5 bg-gray-900 dark:bg-white" style={{ height: `${h}px` }} />
                      ))}
                    </div>
                    <p className="text-[8px] font-mono text-gray-500 dark:text-gray-400 mt-2"><T>RFID / Code scanner sweep</T></p>
                  </div>
                  <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                    <T>
        ...
        <section className="py-20 border-b border-gray-100 dark:border-gray-900 bg-gray-50 dark:bg-gray-950">
          <div className="container mx-auto px-4 max-w-3xl">
            <ScrollReveal direction="scale" delay={0.1} spring once>
              <Card className="border-gray-200 dark:border-gray-800 bg-gradient-to-br from-gold-50 to-transparent dark:from-gold-950/10 dark:to-transparent overflow-hidden relative">
                <div className="absolute top-0 right-0 w-64 h-64 bg-gold-500/5 rounded-full blur-3xl" />
                <CardContent className="py-8 px-6 md:px-8 relative z-10">
                  <div className="flex flex-col sm:flex-row items-start gap-5">
                    <div className="shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-gold-400 to-gold-600 flex items-center justify-center shadow-lg shadow-gold-500/20">
                      <ArrowPathIcon className="w-6 h-6 text-gray-950 stroke-[2.5]" />
                    </div>
                    <div>
                      <h3 className="font-bold text-lg text-gray-900 dark:text-white mb-2 flex items-center gap-2 flex-wrap">
                        <T>Silent Background Autoupdates</T>
                        <span className="text-[10px] px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 font-semibold font-mono">
                          v0.2.0+
                        </span>
                      </h3>
                      ...
                      <div className="flex flex-wrap gap-2.5">
                        {[
                          ...
                          <span
                            key={tag}
                            className="text-[10px] px-2.5 py-1 rounded bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700 font-medium"
                          >
                            <T>{tag}</T>
                          </span>
                        ))}
        ...
        {/* ═══ Setup Guides ═══ */}
        <section className="py-20 border-b border-gray-100 dark:border-gray-900 bg-white dark:bg-gray-950">
