    ...
    <div className="min-h-screen bg-white dark:bg-[#0B0C10] text-gray-900 dark:text-gray-100 flex flex-col">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3 text-xs md:text-sm">
              <li className="flex items-center gap-2 font-medium">
                ...
                <span><strong><T>Biometric Staff Scan:</T></strong> <T>Restricts high-clearance actions like inventory adjustments, discount approvals, or daily registers to verified fingerprint scans.</T></span>
              </li>
              <li className="flex items-center gap-2 font-medium">
                <Scan className="h-4 w-4 text-amber-500" />
                <span><strong><T>RFID Tag Integration:</T></strong> <T>Fast-tracks morning showcases stock audit, counting hundreds of gold ornaments simultaneously to detect shrinkage in minutes.</T></span>
              </li>
              <li className="flex items-center gap-2 font-medium">
                <Cpu className="h-4 w-4 text-blue-500" />
                <span><strong><T>BIS Hallmark &amp; HUID Tracking:</T></strong> <T>Every piece is bound to its unique Government Hallmark ID, protecting you against counterfeit stock.</T></span>
              </li>
            </ul>
          </div>
          <div className="relative flex justify-center">
            ...
            <Card className="border border-gray-150 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-xl w-72 max-w-full">
              <CardContent className="pt-6 space-y-4 text-center">
                ...
                <h3 className="font-bold text-sm"><T>Security Proof Checklist</T></h3>
                <div className="text-left space-y-2 pt-2">
                  <div className="flex items-center justify-between text-xs border-b dark:border-gray-800 pb-1.5">
                    <span className="text-muted-foreground"><T>TLS 1.3 In-Transit</T></span>
                    <Badge variant="outline" className="bg-emerald-500/10 text-emerald-600 border-emerald-500/20 text-[9px] px-1 py-0"><T>Elite</T></Badge>
                  </div>
                  <div className="flex items-center justify-between text-xs border-b dark:border-gray-800 pb-1.5">
                    <span className="text-muted-foreground"><T>ISO 27001 Ready</T></span>
                    <Badge variant="outline" className="bg-emerald-500/10 text-emerald-600 border-emerald-500/20 text-[9px] px-1 py-0"><T>Certified</T></Badge>
                  </div>
                  <div className="flex items-center justify-between text-xs border-b dark:border-gray-800 pb-1.5">
                    <span className="text-muted-foreground"><T>Biometric Staff Auth</T></span>
                    <Badge variant="outline" className="bg-blue-500/10 text-blue-600 border-blue-500/20 text-[9px] px-1 py-0"><T>Supported</T></Badge>
                  </div>
                  <div className="flex items-center justify-between text-xs pb-1">
                    <span className="text-muted-foreground"><T>Automated Daily Seed</T></span>
                    <Badge variant="outline" className="bg-emerald-500/10 text-emerald-600 border-emerald-500/20 text-[9px] px-1 py-0"><T>Active</T></Badge>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="max-w-5xl mx-auto px-4 py-24 space-y-10 border-t dark:border-gray-800/60">
        <div className="text-center space-y-3">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight"><T>Verifiable Security Credentials</T></h2>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Card className="border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900/50 hover:shadow-lg transition-all duration-300">
            <CardContent className="pt-6 space-y-3">
              <span className="text-xs font-bold uppercase tracking-wider text-amber-500"><T>Cloud Storage</T></span>
              <h4 className="font-bold text-sm"><T>AWS Shield &amp; KMS</T></h4>
              <p className="text-[11px] md:text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                <T>All client inventory databases are hosted inside highly secure, multi-zone virtual clouds. Data at rest is encrypted via hardware security modules aligned with</T> <a href="https://aws.amazon.com/security/" target="_blank" rel="noopener noreferrer" className="text-amber-500 hover:text-amber-600 underline font-semibold transition-colors"><T>AWS Cryptographic Security</T></a>.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900/50 hover:shadow-lg transition-all duration-300">
            <CardContent className="pt-6 space-y-3">
              <span className="text-xs font-bold uppercase tracking-wider text-blue-500"><T>Network Shield</T></span>
              <h4 className="font-bold text-sm"><T>Cloudflare DDoS Gate</T></h4>
              <p className="text-[11px] md:text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                <T>We mitigate bots and potential network threats at the DNS boundary. Our API endpoints are protected under enterprise-grade web shield protocols, verified by</T> <a href="https://www.cloudflare.com/web-application-security/" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 underline font-semibold transition-colors"><T>Cloudflare Web Security</T></a>.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900/50 hover:shadow-lg transition-all duration-300">
            <CardContent className="pt-6 space-y-3">
              <span className="text-xs font-bold uppercase tracking-wider text-purple-500"><T>Government Sync</T></span>
              <h4 className="font-bold text-sm"><T>BIS Hallmark HUID APIs</T></h4>
              <p className="text-[11px] md:text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
      ...
      <section className="max-w-4xl mx-auto px-4 pb-24 text-center space-y-8">
        <h2 className="text-2xl md:text-3xl font-bold tracking-tight"><T>Compliance &amp; Reliability</T></h2>
        <div className="grid gap-6 md:grid-cols-2">
          <div className="p-5 rounded-2xl border border-gray-100 dark:border-gray-800 bg-white/40 dark:bg-gray-900/40 text-left space-y-2">
            ...
            <h3 className="font-bold text-sm"><T>Regulatory Tax Alignment</T></h3>
          ...
          <div className="p-5 rounded-2xl border border-gray-100 dark:border-gray-800 bg-white/40 dark:bg-gray-900/40 text-left space-y-2">
            ...
            <h3 className="font-bold text-sm"><T>Offline Counter POS Sync</T></h3>
            <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
