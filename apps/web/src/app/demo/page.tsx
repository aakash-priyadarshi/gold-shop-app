...
// Video served from Cloudflare R2 via orivraa-images worker with Range support.
// Swap lang param to show Hindi version once uploaded.
const DEMO_VIDEO_URL = "https://images.orivraa.com/demo/en";
...
const videoSchema = {
  ...
  "@type": "VideoObject",
  name: "Orivraa — Complete Jewellery Shop Software Demo 2026",
  description:
    "Full 24-minute walkthrough of Orivraa jewellery shop software. Watch live demos of GST/VAT billing, POS transactions, inventory by weight & purity, digital catalogues, karigar tracking, tax engine, and AI-powered business insights.",
...
// ──────────────────────────────────────────────────────────────────
// Timestamp index shown below the player — helps SEO and UX
// ──────────────────────────────────────────────────────────────────
const CHAPTERS = [
...
// ──────────────────────────────────────────────────────────────────
// Feature highlights shown under the video
// ──────────────────────────────────────────────────────────────────
const FEATURES = [
  {
    icon: Scale,
...
// ──────────────────────────────────────────────────────────────────
// What makes Orivraa different — trust signals for SEO landing
// ──────────────────────────────────────────────────────────────────
const TRUST_POINTS = [
...
export default function DemoPage() {
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100">
      {/* JSON-LD for Google Video rich results */}
      <script
      ...
      <section className="pt-20 pb-8 px-4 text-center bg-gradient-to-b from-gray-900 to-gray-950">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-4">
            ...
            <span className="text-amber-400">Complete Walkthrough</span>
          </h1>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-8">
            Watch how jewellery shop owners manage inventory, billing, POS, digital
            catalogues, and karigars — all in one place. 24-minute demo, no fluff.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl ring-1 ring-white/10"
            ...
            <video
              ...
              aria-label="Orivraa jewellery shop software demo video"
            >
              <source src={DEMO_VIDEO_URL} type="video/mp4" />
              Your browser does not support HTML5 video. Please{" "}
              <a href={DEMO_VIDEO_URL} className="text-amber-400 underline">
          ...
          {/* Language switcher — extend once Hindi is uploaded */}
      ...
      {/* ── SEO TEXT ─────────────────────────────────────────── */}
      {/*
        Keyword-rich text for crawlers.
        Hidden from sighted users with sr-only; still fully accessible and indexed.
      */}
      <section className="sr-only" aria-hidden="false">
        ...
        <p>
          ...
          and the USA. This demo video shows a full walkthrough of all key features:
          jewellery billing software with GST and VAT support, jewellery POS software
          for fast counter sales, jewellery inventory software that tracks items by
          weight, karat, and purity, digital catalogue software to share your collection
          online, karigar management to track artisan work orders and metal issued, and
          AI-powered business analytics.
        </p>
        <p>
          This is the best jewellery shop software demo 2026 for sona chandi shops,
          ...
          Nepal, UAE prices shown. Hindi video demo coming soon.
        </p>
      </section>
