/**
 * One-time seed: populates all system email templates in the DB.
 * Run with: pnpm -F @gold-shop/api exec ts-node ../../scripts/seed-email-templates.ts
 */
...
async function main() {
  ...
  console.log('Already in DB:', [...existingKeys].join(', ') || '(none)');
